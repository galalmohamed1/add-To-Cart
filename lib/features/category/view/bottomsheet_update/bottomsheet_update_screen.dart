...
class BottomsheetUpdateScreen extends StatefulWidget {
  final ProductModel product;
  final int id;
   const BottomsheetUpdateScreen({super.key, required this.product, required this.id});

  @override
  State<BottomsheetUpdateScreen> createState() => _BottomsheetUpdateScreenState();
}

class _BottomsheetUpdateScreenState extends State<BottomsheetUpdateScreen> {
  int count = 1;
  int isSelected = -1;
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      cartcubit.updateItem(updatedItem);
                    ...
                    child:  Row(
                      ...
                      children: [
                        ...
                        const Spacer(),
                        Text(
                          "${cartcubit.calculateTotalPrice()} EGP",
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 18,
